...
class KonfirmasiDiagnosisFragment : Fragment() {
    private var _binding: FragmentKonfirmasiDiagnosisBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentKonfirmasiDiagnosisBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            btnStartDiagnose.setOnClickListener {
                findNavController().navigate(R.id.action_konfirmasiDiagnosisFragment_to_formCatNameFragment)
            }
