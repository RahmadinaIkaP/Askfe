...
interface DiseaseRepository {
    ...
    fun getGejalaRules(list : ArrayList<String>,response: (ResponseState<MutableList<Rules>>) -> Unit)
    ...
    fun getHistory(idUser : String, response: (ResponseState<List<History>>) -> Unit)
}